        ...
        <div class="min-height-200px">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 text-right">
                    <a class="btn btn-dark mb-3" href="{{ route('exportarEmpleado') }}">
                        EXPORTAR <i class="icon-copy dw dw-download1 ml-1"></i>
                    </a>
                    <a class="btn btn-dark mb-3" href="{{ route('exportarPuesto') }}">
                        EXPORTAR PUESTOS<i class="icon-copy dw dw-download1 ml-1"></i>
                    </a>
                        ...
                        <div class="modal-dialog modal-dialog-centered ">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title text-blue" id="my-crear-unidad-modal">Importar Empleados</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                        <i class="icon-copy fa fa-close" aria-hidden="true"></i>
                                    </button>
                                </div>
                                <form id="formImportarEmpleados" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="form-group col-md-12 mb-2 text-center">
                                                <label>Seleccionar Archivo</label>
							                    <input type="file" id="fileEmpleado" name="fileEmpleado" class="form-control-file form-control height-auto">                                            </div>
                                        </div>
                                    </div>
